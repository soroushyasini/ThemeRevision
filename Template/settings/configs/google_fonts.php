<fieldset>
    <legend><i class="fa fa-cloud"></i><a href="https://fonts.google.com/" target="_blank" rel="noopener noreferrer"><?= t('Google Fonts') ?></a></legend>
    <p><small>
        ...
        <?= t('If this feature is not working, please check the CSP settings on your server first.') ?> <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy" target="_blank" rel="noopener noreferrer"><?= t('More') ?></a><br>
    </small></p>
